...
module cla64_flat(
  ...
  // Continue the same direct CLA pattern for c[16] through c[64].
  // To avoid an error-prone manually expanded block, use the following
  // equivalent recursive lookahead form.
